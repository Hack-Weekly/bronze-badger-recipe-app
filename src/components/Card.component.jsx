...
export const Card = ({cocktailDetails,cocktailName,cocktailImg}) => {
  return (
    <div className='m-3 p-5 flex flex-col bg-primary-color w-72 h-80 rounded-lg hover:bg-primary-hover hover:drop-shadow-md'>
