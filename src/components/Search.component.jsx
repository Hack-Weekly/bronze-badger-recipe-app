  ...
  return (
    <>
      <div className="relative mt-2 rounded-md shadow-sm">
        ...
        <button className='mt-5 rounded-xl bg-secondary-color p-2' onClick={clickHandler} type="submit">GO</button>
        <button className='ml-2 mt-5 rounded-xl bg-secondary-color p-2' onClick={props.onClick}>Surprise Me!</button>
    </>
  )
});
