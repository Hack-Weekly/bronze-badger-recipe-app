...
export const Navbar = () => {
  return (
    <nav className="bg-primary-color-light dark:bg-primary-color-dark  w-screen mb-auto flex items-center px-2 border-b-2 dark:border-secondary-color-dark border-secondary-color-light">
        ...
        <div className='md:hidden'>
          <Input variant='primary' size='sm' placeholder='Search for drink'/>
        </div>
